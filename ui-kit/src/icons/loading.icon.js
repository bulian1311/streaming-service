...
export const LoadingIcon = ({ ...props }) => ( 
  <StyledSvg {...props} viewBox="0 0 128 128">   
      <g>
        ...
        <animateTransform attributeName="transform" type="rotate" from="0 64 64" to="360 64 64" dur="400ms" repeatCount="indefinite"></animateTransform>
      </g>
  </StyledSvg>
);