...
const Requirements = () => {
  return /*#__PURE__*/React.createElement(StyledDiv, null, "Hello World");
};
...
const StyledSvg = styled(SvgAttrs)`
...
}) => /*#__PURE__*/React.createElement(StyledSvg, _extends({}, props, {
...
const Button = ({
  ...
  return /*#__PURE__*/React.createElement(StyledButton, _extends({
    reverse: reverse
  }, props), isLoading ? /*#__PURE__*/React.createElement(LoadingIcon, null) : children);
};
...
const Input = ({
  ...
  return /*#__PURE__*/React.createElement(InputGroup, null, label && /*#__PURE__*/React.createElement(StyledLabel, null, label), /*#__PURE__*/React.createElement(StyledInput, otherProps));
};
...
const Modal = ({
  ...
  if (!isVisible) return '';
  return /*#__PURE__*/React.createElement(ModalContainer, otherProps, /*#__PURE__*/React.createElement(ModalBody, null, /*#__PURE__*/React.createElement(Tag, {
  ...
  }, /*#__PURE__*/React.createElement(CancelIcon, null)), children));
};
...
const Tabs = ({
  ...
  return /*#__PURE__*/React.createElement(Container, props, /*#__PURE__*/React.createElement(StyledUl, null, tabs.map(tab => /*#__PURE__*/React.createElement(StyledLi, {
    key: tab
...
export { Button, main_colors as Colors, index as Icons, Input, Modal, Requirements, Tabs, Tag };
